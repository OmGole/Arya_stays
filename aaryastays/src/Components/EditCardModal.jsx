  ...
  return (
    ...
    <div className="bg-white px-8 py-5 rounded mx-auto box-border">
      ...
      <form action="" className='font-montserrat text-sm'>
        ...
        <button className='block w-full bg-green-500 text-white py-2 px-5 rounded-full hover:bg-white hover:text-green-500 border-2 border-green-500 transition duration-200 box-border text-l mb-3 font-poppins' onClick={handleUpdateCard}>Edit</button>
      </form>
    </div>
    </Modal.Body>
  </Modal>
