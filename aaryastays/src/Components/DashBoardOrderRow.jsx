...
function DashBoardOrderRow({ order }) {
  ...
  return (
    <div className="md:flex text-center py-9 md:justify-center content-center items-center border-b-2 border-black">
      ...
      <div className="basis-1/6 mb-3">
        <Link
          className="block bg-[#F79489] text-white py-1 px-5 rounded-full ml-9 hover:bg-white hover:text-[#F79489] border-2 border-[#F79489] transition duration-200 box-border" to={`/dashboard/order/${order._id}`}
        >
          View More
        </Link>
      </div>
