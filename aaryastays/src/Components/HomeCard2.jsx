    ...
    <div className=' mx-8 p-3 bg-white flex flex-col-reverse md:flex-row custom-shadow rounded'>
        <div className='md:w-2/3 md:pl-4 py-2 pl- '>
            <div className='flex justify-between items-center'>
                ...
                <div class={`button ${isInWishlist ? 'animate active' : ''} cursor-pointer`} onClick={()=>{toggleClass()}}>
            ...
            <div className='flex my-1 justify-between md:justify-start pr-2'>
                {property.roomType.map((item,index)=>{
                return(
                    (item == 'full-property' && <div className='flex md:mr-4  items-center text-sm'><img src={FullProperty} alt='full' className='mr-1'></img> Full Property</div>) ||
                    (item == 'private-rooms' && <div className='flex md:mr-4 items-center  text-sm'><img src={PrivateRoom} alt='private' className='mr-1'></img> Private Room</div>) ||
                    (item == 'dorm-beds' && <div className='flex md:mr-4 items-center  text-sm'><img src={DormRoom} alt='dorm' className='mr-1'></img> Dorm Room</div>))
                })}
