  ...
  return (
    ...
    <div className="bg-white px-8 py-5 rounded mx-auto box-border">
      ...
      <form action="" className='font-montserrat text-sm'>
        ...
        <button className='block w-full bg-[#F79489] text-white py-2 px-5 rounded-full hover:bg-white hover:text-[#F79489] border-2 border-[#F79489] transition duration-200 box-border text-l mb-3 font-poppins' onClick={handleCreateCard}>Add</button>
      </form>
    </div>
    </Modal.Body>
  </Modal>
