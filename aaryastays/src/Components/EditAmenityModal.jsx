...
const EditAmenityModal = ({amenity,openModal,setOpenModal}) => {
  ...
  return (
    ...
    <div className="bg-white px-8 py-5 rounded mx-auto box-border">
      <h2 className='text-3xl mb-3 text-center font-poppins'>Edit Amenity</h2>
      <form action="" className='font-montserrat text-sm'>
        ...
        <button className='block w-full bg-green-500 text-white py-2 px-5 rounded-full hover:bg-white hover:text-green-500 border-2 border-green-500 transition duration-200 box-border text-l mb-3 font-poppins' onClick={handleUpdateAmity}>Edit</button>
      </form>
    </div>
    </Modal.Body>
  </Modal>
