...
import HomeCard1 from './HomeCard';
...
export default function Listing() {
  ...
  return (
    <div className='text-black'>
      <div className='container  py-16 mx-auto   mx-auto '>
        ...
        {arr.map((item, index) => (
        <div className='w-100 md:h-56 h-96 even:bg-[#FABEB7] odd:bg-[#D1EDF5] md:mt-40 md:mt-32 mt-44  relative'>
